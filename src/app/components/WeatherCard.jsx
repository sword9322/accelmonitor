      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center">
          {weatherData.icon ? (
            ...
            <div className="w-[50px] h-[50px] mr-3 bg-gray-200 dark:bg-gray-700 rounded flex items-center justify-center">
          ...
          <div className="text-2xl font-bold text-white dark:text-white">{weatherData.temperature?.toFixed(1)}°C</div>
        </div>
      </div>
